 ...
 * Created: October 31, 2022 @ 11:00 PM
 * Purpose: v5: Implement creating 2 random boards and assigning to 2 players.
 * Refactor code if necessary before moving on to implement game logic.
 */
